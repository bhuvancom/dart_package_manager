...
class SuggestPackagesUseCase {
  ...
  Future<List<SuggestedPackage>> execute(String requirement,
      {String? apiKey, String? modelName, String? language}) async {
    return await repository.getSuggestions(requirement,
